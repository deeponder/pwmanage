...
<div class="col-sm-offset-1" id="postcontent">
         ...
         <div id="<?php echo $list['id']; ?>">
             ...
             <span><?php echo $list['nick_name']; ?></span>&nbsp&nbsp<span>  <a href="#" class="pop"><img src="../app/uploads/<?php echo $list['image']; ?>.jpg" id="imageresource" height="50" width="50"> </a></span>&nbsp&nbsp<span><?php echo $list['content']; ?></span>&nbsp&nbsp&nbsp&nbsp&nbsp<span>published at:<?php echo $list['published_at']; ?></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span class="admire-cnt">
